...
using Company.WomanOfParis;

namespace WomanOfParis_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new WomanOfParisPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Company.WomanOfParis.GuidList.guidWomanOfParisCmdSet, (int)Company.WomanOfParis.PkgCmdIDList.cmdidWomanOfParisCommand);
